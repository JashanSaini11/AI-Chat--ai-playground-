 ...
 */
let templateStorage: Template[] = (
  templatesData.templates as unknown as Template[]
).map((t) => ({
  ...t,
...
• Temperature: ${config.temperature} ${
        config.temperature > 1 ? "(Creative)" : "(Focused)"
      }
...
${
  config.temperature > 1.2
    ? "🎨 **Creative Mode:** I'm generating more diverse and imaginative responses!"
    : "🎯 **Focused Mode:** I'm providing precise and deterministic responses."
}
